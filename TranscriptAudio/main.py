...
if __name__ == '__main__':
    ...
    while True:
        ...
        if audio_or_text_choice == '3':
            ...
            choice = input(Const.TRANSCRIPT_CHOICES)
            ...
            # Transcript audio file
                ...
                complete_fname = '.\\TranscriptAudio\\Audio\\' + fname  # Relative audio file path
                ...
                try:
                    ...
                    if os.path.isfile(complete_fname):
                        ...
                        try:
                            ...
                            complete_fname = '.\\TranscriptAudio\\Transcripts\\' + fname + '.txt'
            ...
            # Capture input from microphone
                ...
                fname = 'recording.wav'
                complete_fname = '.\\TranscriptAudio\\Audio' + '\\' + fname  # Relative file path
                transcript_audio_file = TranscriptAudioFile(fname, complete_fname)
                ...
                try:
                    ...
                    fname = transcript_audio_file.check_file_name()
                    fname += '.txt'
                    transcript_audio_file.complete_fname = ".\\TranscriptAudio\\Transcripts\\" + fname
                    transcript_audio_file.save_txt_file(text)
                except Exception:
                    raise WriteFileException()
